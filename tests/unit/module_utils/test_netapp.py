...
from ansible_collections.netapp.common.plugins.module_utils.netapp import NetAppESeriesModule, create_multipart_formdata
from ansible_collections.netapp.common.tests.unit.modules.utils import AnsibleExitJson, AnsibleFailJson, ModuleTestCase, set_module_args
...
class NetappTest(ModuleTestCase):
    REQUIRED_PARAMS = {"api_username": "rw",
                       ...
                       "ssid": "1"}
    REQ_FUNC = 'ansible_collections.netapp.common.plugins.module_utils.netapp.request'
